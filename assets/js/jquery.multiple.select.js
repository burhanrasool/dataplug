 ...
 * Some changes had made here for specially for mapview multiple filter ..
 * 
 * If found any trouble in other side will have to use another copy of this api.
 * ubaid
 */
        ...
        events: function() {
            ...
            this.$selectAll.off('click').on('click', function() {
                ...
                that.options.onClick({
                    rel: $(this).parent().parent().parent().parent().parent().prev().attr('rel'),
