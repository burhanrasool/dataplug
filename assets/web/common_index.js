    ...
    $('#form-preview').find('.taketimeclass').each(function () {
        ...
        if (recordExist)
        {
            ...
            if (alreadySubmitted)
            {
                ...
                {
                    if ($(this).find('input:first').attr('action_before') != '') {
...
//Events Call area
    ...
    $('input[type="number"]').keyup(function () {
        ...
        var element_value = parseInt($(this).attr('value'));
        var element_id = $(this).attr('id');
    ...
    $('.page-next').live('click', function (e) {
    ...
    $('.page-previous').live('click', function (e) {
    ...
    $('.page-skip').live('click', function (e) {
    ...
    $('.edit-field-loop').live('click', function (e) {
    ...
    $('.loop-listing').live('click', function () {
    ...
    $('.cancel-cls').live('click', function (e) {
        var current_loop_id = $(this).attr('loop_id');
    ...
    $('.save-cls').live('click', function (e) {
        ...
        $('#popup-' + current_loop_id).find('[field_setting="main"]').each(function () {
            ...
            if ($($(this).id + '-container').css('display') != 'none' && $(this).attr('required') != undefined && $(this).attr('value') == '')
            {
    ...
    $('.delete-cls').live('click', function () {
        var current_list_id = $(this).attr('current_list_id');
        $('#' + current_list_id).remove();
        var current_loop_id = $(this).attr('loop_id');
        $('#popup-' + current_loop_id).hide('scale');
...
function isrequiredednext(current_page) {
    ...
    $('#' + current_page).find('[field_setting="main"]').each(function () {
        ...
        } else
        {
            ...
            if ($(this).attr('required') != undefined && $($(this).id + '-container').css('display') != 'none') {
...
function minMaxValidation(element_object_sent, orignal_value) {
    ...
    {
        if (parseInt(element_object_sent.attr('min')) >= parseInt(orignal_value))
        {
            var message = ' Your entered number should be greater then ' + element_object_sent.attr('min') + ' in ' + element_object_sent.attr('name') + ' field';
            AndroidFunction.showAlertDialog(message);
            return false;
        }
    }
    ...
    {
        if (parseInt(element_object_sent.attr('max')) <= parseInt(orignal_value))
        {
            var message = ' Your entered number should be less then ' + element_object_sent.attr('max') + ' in ' + element_object_sent.attr('name') + ' field';
            AndroidFunction.showAlertDialog(message);
            return false;
        }
    }
...
function isValidTime(element_object_sent, orignal_value) {
    ...
    if (element_object_sent.attr('time_validation') != undefined && element_object_sent.attr('time_validation') != '')
    {
        ...
        var e_hour = parseInt(e[0]);
        var e_min = parseInt(e[1]);
        var s_hour = parseInt(s[0]);
