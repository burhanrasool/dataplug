   $('#screen_size').change(function() {
                ...
                else if(size==2)//for sony
                {
                    ...
                    $('#form-builder').attr('style','width:292px;position: relative;top: 19px;left: 182px;height:517px;overflow-y: auto;')
                }
                else if(size==3)//for htc
                {
                    ...
                    $('#form-builder').attr('style','width:276px;position: relative;top: 23px;left: 192px;height:489px;overflow-y: auto;')
                }
                else if(size==4)//for Samsung Yound 2
                {
                    ...
                    $('#form-builder').attr('style','width:228px;position: relative;top: 96px;left: 217px;height:333px;overflow-y: auto;font-size:80%;')
                }
