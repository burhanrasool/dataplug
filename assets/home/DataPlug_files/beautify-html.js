...
/**
 * MODIFICATIONS HAVE BEEN MADE TO THIS SCRIPT FOR FORMBUILDER
 * Specifically:
 * 1. extra_liners: 'form,div,head,body,/html'.split(',') (added form and div to the list)
 * 2. Added an extra this.print_newline(true, this.output); in the get_tag function (line 265)
 * 3. Added if statement
 * **/
...
//Wrapper function to invoke all the necessary constructors and deal with the output.
  ...
  function Parser() {
    ...
    this.Utils = { //Uilities made available to the various functions
      ...
      extra_liners: 'form,div,head,body,/html'.split(','), //for tags that need a line of whitespace before them
      same_line: ['label', 'textarea'],
    ...
    this.get_tag = function () { //function to get a full tag and parse its type
      ...
      return {tag:content.join(''), tag_check:tag_check}; //returns fully formatted tag
    };
    ...
    this.get_token = function () { //initial handler for token-retrieval
      ...
      if(this.current_mode === 'TAG') {
        ...
        if (typeof token !== 'string') {
          ...
          return [token, tag_name_type, full_tag.tag_check];
        }
      }
    }
  ...
  while (true) {
      ...
      multi_parser.tag_check = t[2];
//console.log( multi_parser.tag_check);
    ...
    switch (multi_parser.token_type) {
      case 'TK_TAG_START': case 'TK_TAG_SCRIPT': case 'TK_TAG_STYLE':
        multi_parser.prev_start_tag = multi_parser.tag_check;
        ...
        break;
      case 'TK_TAG_END':
        var ttype = multi_parser.tag_check.substr(1);
        if((ttype != 'textarea'))
