...
class Ajax_pagination {
    ...
    var $first_link           = '<input type="submit" value="First">';
    var $next_link            = '<input type="submit" value="Next">';
    var $prev_link            = '<input type="submit" value="Previous">';
    var $last_link            = '<input type="submit" value="Last">';
    var $uri_segment        = 3;
    var $full_tag_open        = '';
    var $full_tag_close        = '';
    var $first_tag_open        = '';
