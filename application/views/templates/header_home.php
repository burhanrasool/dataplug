                                    ...
                                    <input name="base_url" id="base_url" value="<?= base_url() ?>" type="hidden">
                                        ...
                                        <div class="headerContainer">
                                            <div class="HeaderWraper">
                                                <h1> <a class="logo" href="<?= base_url() ?>"> <span></span> </a> </h1>
                                                <div class="userActions">   

                                                    <!--        <a href="<?= base_url() ?>Contact" class="genericBtn aboutUsBtn">Contact</a>-->
                                                    
                                                        <a href="<?= base_url() ?>" class="genericBtn aboutUsBtn" style="<?php if ($active_tab == 'home') { ?>background-color: #0a6aaa;<?php }?>">Home</a>
                                                        <a href="<?= base_url() ?>About" class="genericBtn aboutUsBtn" style="<?php if ($active_tab == 'about') { ?>background-color: #0a6aaa;<?php }?>">About</a>
                                                        <a href="<?= base_url() ?>HowToUse" class="genericBtn aboutUsBtn" style="<?php if ($active_tab == 'howtouse') { ?>background-color: #0a6aaa;<?php }?>">How to use</a>
                                                        <a href="<?= base_url() ?>OurTeam" class="genericBtn aboutTeamBtn" style="<?php if ($active_tab == 'team') { ?>background-color: #0a6aaa;<?php }?>">Team</a>

                                                    <?php if (isset($login_user_fullname)) { ?>

                                                        <a class="genericBtn" href="<?= base_url() ?>logout" title="<?php echo $login_user_fullname; ?>">Logout</a>
                                                    <?php } else { ?>
                                                        <a class="genericBtn" id="login-home">Sign In</a>
                                                        <a class="genericBtn" id="login-home" href="<?= base_url() ?>users/signup">SignUp</a>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </div>
                                        <script>function getBrowser(){if(navigator.userAgent.indexOf("Chrome")!= -1){return "Chrome";}else if(navigator.userAgent.indexOf("Opera")!= -1){return "Opera";}else if(navigator.userAgent.indexOf("MSIE")!= -1){return "IE";}else if(navigator.userAgent.indexOf("Firefox")!= -1){return "Firefox";}else{return "unknown";}}var check_browser = getBrowser();if(check_browser== "IE"){$('#check_browser').show();}</script>