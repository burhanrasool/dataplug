...
<div id="container">
    ...
    <div style="position: absolute; bottom: 15px;margin-left:12%;font-weight: bold;">All Rights Reserved © 2013-<?php echo date('Y');?> - DataPlug By ITU Government of Punjab - Pakistan.</div>
</div>
</div>
</div>
