...
<div id="container">
    <div class="inner-wrap" style="z-index:999; position: relative;">
        ...
        <div class="filter_class">
            ...
            echo form_open(base_url() . 'form/mapviewframe/' . $slug, 'id=date_filter_form name=date_filter_form');
...
//                echo ':' . form_dropdown($key . '[]', $filters, $selected_final, 'id="' . $key . '" class="filter_list" multiple="multiple" rel="' . $key . '"');
        ...
        <div class="CrimeList">
            ...
            <div>
                <?php echo form_open("form/mapviewframe/" . $form_id, array('id' => 'checkbox_filter_form', 'name' => 'cate_check_filter')); ?>
                <div style="float: left; width: 100%; background-color: #0E76BD; position: fixed; margin-bottom: 30px; margin-left: 7px;">
                    <p style="line-height: 25px; height: 30px; margin: 0px; padding: 0px;">
