                            ...
                            foreach ($headings as $heading):
                                if ($heading != 'is_take_picture'):
                                    if($heading == 'activity_status'){
                                        if((!isset($app_general_setting['activity_status_change']) || $app_general_setting['activity_status_change']==0)){
                                            continue;
                                        }
                                    }
                                    ?>
                                    ...
                                    <td class="Category <?php echo $leftaligh; ?>" style="position:relative; padding: <?php echo $padding; ?> ;" >
                                        ...
                                        if($headings[$i]=='activity_status'){
                                            ...
                                            if ($headings[$i] == 'image') {
                                                ...
                                                ?>
                                                <a href="<?php echo get_image_path($form_item[$headings[$i]][0]['image']); ?>" rel="lightbox['<?php echo $image_colorbox; ?>']" title='<b><?php echo $title; ?></b>'>
                                                    <img align="left" src="<?php echo get_image_path($form_item[$headings[$i]][0]['image']); ?>" width="50" height="50" alt="Record Images" title="<b>Record Images</b>" />
                                                </a>
                                                <?php
//                                                
                                                ...
                                                foreach ($form_item[$headings[$i]] as $multi_image) {
                                                    ...
                                                    if (array_key_exists($multi_title_inside, $form_item)) {
                                                        ...
                                                        $title_multi = $multi_image['title'];
                                                    }
                                                    ?>
                                                    <a rel="lightbox['<?php echo $image_colorbox; ?>']" href="<?php echo get_image_path($multi_image['image']); ?>" title="<b><?php echo $title_multi; ?></b>" name = " ITU Government of Punjab - Pakistan">
                                                    </a>
                                                    <?php
                                                }
...
//                                                $data = ($headings[$i] != "Description") ? $form_item[$headings[$i]] : strtoupper($form_item[$headings[$i]]);
                                                ...
                                                ?>
                                                    <a rel="<?php echo "zform_".$form_item['form_id']."_".$headings[$i]."_".$form_item['actions'];  ?>" href="javascript:void(0)"  name = " ITU Government of Punjab - Pakistan" class="open_subtable">
