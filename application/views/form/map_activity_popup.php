                    ...
                    if (isset($data_array['image']) && $data_array['image'][0]['image']) {
                        foreach ($data_array['image'] as $image) {
                            ...
                            <a rel="lightbox[]"  href="<?php echo $image['image'] ?>" title="<b><span style='font-weight: 900;font-family: Sans-serif'><?php echo ($title) ? ucwords(strtolower($title)) : 'No Title'; ?></span><b>">
                                <img width="97%" height="96%" src="<?php echo get_image_path($image['image']); ?>" title="Zoom"> 
                            </a>
                            <a rel="lightbox['<?php echo $locations[0]['id']; ?>']" class="zoomIcon lightbox" href="<?php echo get_image_path($image['image']); ?>" title="<b><span style='font-weight: bold;font-family: Sans-serif'><?php echo ($title) ? ucwords(strtolower($title)) : 'No Title'; ?></span><b>">
                            </a>
                            <?php
                        }
                    } else {
                        ?>
                        <a rel="lightbox['<?php echo (isset($locations[0]))?$locations[0]['id']:''; ?>']"  href="<?php echo base_url() . 'assets/images/no_image.png'; ?>">
