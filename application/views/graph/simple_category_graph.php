...
<div style="width: 190px; float:right;">
    <a href="<?php echo base_url().'customreports/dashboard/'.$app_id; ?>">
    <input type="button" value="Custom Reports"  class="genericBtn">
</a>
</div>
</form>
...
<?php
    if(isset($filter_result->bar_graph_filters) && $filter_result->bar_graph_filters==1) {
        ?>
        <div id="container" style="width: 100%; height: 441px; overflow: auto; margin: 0 auto; float: right;">    </div>
    <?php 
    
    }else if(!isset($filter_result->bar_graph_filters)){
        ?>
        <div id="container" style="width: 100%; height: 441px; overflow: auto; margin: 0 auto; float: right;">    </div>
    <?php
    }?>
    ...
    <?php if ($app_id == '1567') { ?>
        ...
        ?>
            <div style="">
                ...
                <div style="float: left;margin-right: 50px;display: none;">
                    <a style="position:relative;"  href="<?php base_url()?>/graph/monthwisereport/<?php echo $app_id;?>/?from_date=<?php echo!empty($from_date) ? $from_date : ""; ?>&to_date=<?php echo!empty($to_date) ? $to_date : ""; ?>"><button>Month Wise Report</button></a>
                </div>
...
//                                            this check added for dataplug for application school inspection
                            ...
                            ?> 
                                <td><a href="<?php base_url()?>/graph/subreport/<?php echo $app_id;?>/?district=<?php echo $districts;?>&from_date=<?php echo!empty($from_date) ? $from_date : ""; ?>&to_date=<?php echo!empty($to_date) ? $to_date : ""; ?>" style="position: relative">Detail</a></td>
                            </tr><?php
                        }
                        ?>
