...
$list_x_axix = '';
$list_y_axix = '';
foreach ($category_wise_counter as $key => $counts) {
    $list_x_axix .= "'$key'" . ',';
    $list_y_axix .= "$counts" . ',';
}
...
if (count($category_wise_counter) > 14) {
    $calculated_height = count($category_wise_counter) * 30;
} else {
                                ...
                                if ($headings[$i] != 'is_take_picture') {
                                    ...
                                    <td class="Category" >
                                        ...
                                        if (isset($form_item[$headings[$i]])) {
                                            if ($headings[$i] == 'image') {
                                                ?>
                                                <a href="<?php echo $form_item[$headings[$i]][0]['image']; ?>" title="All Rights Reserved © 2013-<?php echo date('Y');?> - DataPlug By ITU Government of Punjab - Pakistan" class="image_colorbox"><img alt="" width="50" height="50" src="<?php echo $form_item[$headings[$i]][0]['image']; ?>"></a>
                                                <?php
