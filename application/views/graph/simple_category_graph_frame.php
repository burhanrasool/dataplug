...
<form id='setfilter' method='POST' action='<?= base_url() ?>graph/graphframe/<?php echo $app_id ?>'>
...
<input size ="12" type="text" id="datepicker" readonly="readonly" value="<?php echo!empty($from_date) ? $from_date : ""; ?>" name="filter_date_to"  onchange="check_date_validity()" ondblclick="clear_field(this)">
&nbsp To :&nbsp
<input size="12" type="text" id="datepicker2" readonly="readonly" value="<?php echo!empty($to_date) ? $to_date : ""; ?>" name="filter_date_from"  onchange="check_date_validity()" ondblclick="clear_field(this)">
