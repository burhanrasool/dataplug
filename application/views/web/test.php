    ...
    <head>
        ...
        function AndroidFunctionClass() {
            ...
            this.removeTimeData = function() {
                console.log('DateTime Removed called');
            };
            this.checkTimeStatus = function() {
                console.log('Time Status checked called');
            };
            this.onBackPressShowAlert = function(v) {
                console.log("Back press change status as = "+v);
            };
            this.startTracking = function() {
                console.log('Tracking Started called');
            };
            this.stopTracking = function() {
                console.log('Tracking Stoped called');
            };
            this.takePicture = function(ele) {
                pictureTaken(ele,'abc');
            };
            ...
            this.GetLastActivity  = function() {
                console.log('Call GetLastActivity ');        
                return true;
                
            };

            this.GetCountOfUnSentActivities  = function() {
                console.log('Call GetCountOfUnSentActivities ');        
                return true;
                
            };
            this.takeTime = function(time_id) {
            ...
            var base_url = $('#base_url').val();
             ...
             if ($('#form_id').val() == undefined)
             {
                 ...
                 $('.field').find('[class="formobile"]').each(function () {
                     ...
                     //Creat form url
                     var form_url = base_url+'web/test/'+app_id+'_'+form_id
                ...
                $('#form-title').find('[class="navbar-brand"]').attr('href',base_url+'web/test/'+app_id)
...
//                    }
        ...
        <script src="<?= base_url() ?>assets/web/common.js"></script>
